...
const ShortLeaveRequestCard = (props) => {
    ...
    <React.Fragment>
      ...
      <Box sx={style}>
        <Box sx={{width:"100%",ml:8}} >
          ...
          <Typography sx={{ mt: 1 }}>
            Date: {new Date(props.details.date).toLocaleDateString()}
          </Typography>
          <Typography sx={{ mt: 1 }}>
            Start Time: {props.details.startTime}
          </Typography>
          <Typography sx={{ mt: 1 }}>
            End Time: {props.details.endTime}
          </Typography>
          <Box sx={{ml:15}}>
...
export default ShortLeaveRequestCard;