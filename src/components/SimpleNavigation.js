                ...
                <Container maxWidth="xl">
                    <Toolbar disableGutters>
                        ...
                        <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex', justifyContent: "flex-end" } }}>
                            <Button sx={{ my: 1, color: 'black', display: 'block', fontWeight: "bold", mx: 1 }}>About Us</Button>
                            <Button sx={{ my: 1, color: 'black', display: 'block', fontWeight: "bold", mx: 1 }}>Login</Button>
                        </Box>
                        <Typography
                            variant="h6"
                            noWrap
